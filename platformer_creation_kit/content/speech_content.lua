...
speech_content =
{
	...
	[2] =
	{
		texture = "05 Knight",
		display_name = "Тинк",
		content = "Ой, я видимо потерял его, пока прятался в пещере! То есть восстанавливал силы, готовясь к битве с зомби! Ты должна была видеть вход в ту пещеру по пути сюда...",
		choices =
		{
			[1] =
			{
	...
	[3] =
	{
		texture = "07 Queen",
		display_name = "Хельда",
		content = "Спасибо за освобождение! Я надеюсь Тинк в порядке? Я слышала его крики, но когда спустилась вниз, там уже кишели зомби.",
		choices =
		{
			[1] =
			{
